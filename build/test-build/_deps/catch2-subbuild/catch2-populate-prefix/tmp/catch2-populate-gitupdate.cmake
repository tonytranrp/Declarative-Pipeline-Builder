...
function(do_fetch)
  ...
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/Tonyt/Documents/GitHub/Declarative-Pipeline-Builder/build/test-build/_deps/catch2-src"
...
execute_process(
  COMMAND "C:/Users/Tonyt/AppData/Roaming/npm/git.cmd" --git-dir=.git show-ref "v3.4.0"
  WORKING_DIRECTORY "C:/Users/Tonyt/Documents/GitHub/Declarative-Pipeline-Builder/build/test-build/_deps/catch2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Tonyt/Documents/GitHub/Declarative-Pipeline-Builder/build/test-build/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Tonyt/Documents/GitHub/Declarative-Pipeline-Builder/build/test-build/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
